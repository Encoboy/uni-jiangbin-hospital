...
import GoEasyIM from './goeasy-im-1.3.1';
...
function IMService() {
    this.im = GoEasyIM.getInstance({
        ...
        appkey:'BC-fbda442bb0f642cbba8cae9130b478d5'
    });
    //当前“我”
...
IMService.prototype.topGroupConversation = function (groupId,isTop) {
    let promise = this.im.topGroupConversation(groupId,isTop);
    promise.then(res => {
        console.log(res)
    }).catch(e => {
        console.log(e)
...
IMService.prototype.removeGroupConversation = function (groupId) {
    let promise = this.im.removeGroupConversation(groupId);
    promise.then(res => {
        console.log(res)
    }).catch(e => {
        console.log(e)
