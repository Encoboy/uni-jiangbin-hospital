...
<script>
	export default {
		...
		onLoad(options) {
			...
			this.selectSex = userinfo.selectSex;
			this.nation = userinfo.nation;
			this.work = userinfo.work;
			this.allergy = userinfo.allergy;
			this.phone = userinfo.phone;
			this.location = userinfo.location;
			this.selectMarri = userinfo.selectMarri;
			this.selectRhBlood = userinfo.selectRhBlood;
			this.selectSanguis = userinfo.selectSanguis;
			for(let i = 0;i<this.sexList.length;i++){
				if(this.selectSex == this.sexList[i].label){
					this.sexValue = this.sexList[i].value;
				}
			}
		},
		methods: {
